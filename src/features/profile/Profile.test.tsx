...
describe("Current Profile", () => {
  it("refetches only the Session User and presents Profile with Hired Services", async () => {
    ...
    server.use(
      ...
      http.get(hiredUrl, () => HttpResponse.json({ content: [{ id: 9, maCongViec: 42, maNguoiThue: 700, ngayThue: "2026-08-14", hoanThanh: false, congViec: { tenCongViec: "Accessible logo", giaTien: 120 } }] })),
    );
